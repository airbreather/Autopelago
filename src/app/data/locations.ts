...
const PREPARED_FILLERS = stricterObjectFromEntries(
  strictObjectEntries(FILLER_DEFINING_COORDS)
    .map(([yamlKey, definingCoords]) => [yamlKey, convertDefiningPoints(yamlKey === 'before_basketball', definingCoords)]),
);
